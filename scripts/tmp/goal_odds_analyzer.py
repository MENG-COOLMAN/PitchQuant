...
# 🔴信号强度三档（V3.5.74·2026-09-15·大小球精细化升级·Matches 148,397场时间分割实测）
...
def analyze_goal_odds(odds, poisson=None):
    ...
    # 五级量级(8.3·🔴2026-09-06修正: 以mean连续主判据·mode仅mean异常回退——原mode∈{2,3}误挡mean3.6大球场)
    ...
    out['量级'] = mag
    # 大小球倾向(3.1): 五级 + 🔴信号强度三档（V3.5.74·2026-09-15精细化升级）
    if not mono:
    ...
    # 🔴极端档高估提示（2026-09-15发现·Matches 148,397场·train/test 一致稳健）
